...
public class moving_tiles : MonoBehaviour {
	public referralsoftilesmovement reff_of_tiles;float time=0,movementvalue,time1; Vector3 velocity;[SerializeField] public float increased_value_of_ball_velocity; 
